  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: FxText.sh1("Our Hotels", fontWeight: 600),
        ),
        body: Container(
            child: Container(
                child: Column(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Container(
                      ...
                      child: FxText.b1('St. James\'s Club Morgan Bay',
                          fontWeight: 500)),
                  FxText.b1('Hotel Nacional de Cuba', fontWeight: 500),
                  FxText.b1('Memories Trinidad Del Mar', fontWeight: 500),
                  Container(
